...
If you discover a security vulnerability in Logging Library, please report it privately. **Do not open a public GitHub issue** — public disclosure before a fix is available puts other users at risk.

### Preferred: GitHub private advisory

[Open a private security advisory](https://github.com/LindemannRock/craft-logging-library/security/advisories/new). This routes the report directly to maintainers with no public visibility.
...
- Log injection via crafted entries that break parsers
