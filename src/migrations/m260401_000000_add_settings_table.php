<?php
/**
 * Add Logging Library settings table migration for Craft CMS 5.x
 *
...
/**
 * Add settings table for existing Logging Library installs.
 *
 * @since 5.8.0
 */
class m260401_000000_add_settings_table extends Migration
{
    /**
     * @inheritdoc
     */
